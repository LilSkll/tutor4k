...
const CHAPTERS = [
  ...
  },
  {
    ...
    exercises: [
      { type: "multiple_choice", question: "___ habla español en esta región.", instruction: "Безличное / пассивное se", options: ["Se", "Me", "Te", "Le"], answer: "Se", explanation: "Se habla español — безличная/пассивная конструкция.", grammarTopic: "pronombre-se" },
      { type: "fill_blank", question: "María ___ levanta a las siete.", instruction: "Возвратное se", answer: "se", acceptableAnswers: ["Se"], explanation: "Reflexivo: María se levanta.", grammarTopic: "pronombre-se" },
      { type: "multiple_choice", question: "«Se me rompió el vaso» выражает…", instruction: "Тип конструкции se", options: ["случайность", "приказ", "будущее", "сравнение"], answer: "случайность", explanation: "Se + косв. местоимение + глагол — непреднамеренное действие.", grammarTopic: "pronombre-se" },
      { type: "translation", question: "Здесь продаются книги.", instruction: "Переведите с se pasiva", answer: "Se venden libros aquí", acceptableAnswers: ["se venden libros aquí", "Aquí se venden libros"], explanation: "Se venden libros — пассивная/refleja.", grammarTopic: "pronombre-se" },
      ...
      { type: "fill_blank", question: "Ana y Luis ___ ven cada día.", instruction: "Взаимное se", answer: "se", acceptableAnswers: ["Se"], explanation: "Recíproco: se ven = видят друг друга.", grammarTopic: "pronombre-se" },
    ],
  },
  {
  ...
  },
  {
    ...
    exercises: [
      ...
      { type: "translation", question: "То, что сказал el profesor, es importante.", instruction: "Lo que", answer: "Lo que dijo el profesor es importante", acceptableAnswers: ["lo que dijo el profesor es importante"], explanation: "Lo que = «то, что».", grammarTopic: "relativos-avanzado" },
