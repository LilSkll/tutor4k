...
export default async function DashboardPage() {
  ...
  const nextChapterTitle =
    course.getNextChapter(currentChapter.slug)?.title ?? t("dashboard.final");
      ...
      <Card className="card-hover">
        <CardContent className="p-4">
          <Link href="/courses" className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-sm">{t("dashboard.languagesTitle")}</h3>
      ...
      <Card className="card-hover">
        <CardContent className="p-4">
          <Link href="/chapters" className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-sm">{t("dashboard.journeyMap")}</h3>
              <p className="text-xs text-muted-foreground">
