...
export const CHAPTERS: Chapter[] = [
  {
    ...
    location: "Академия",
    icon: "🌅",
    summary: "Первые шаги: приветствия, знакомство, глаголы ser и estar.",
  ...
  },
  {
    ...
    icon: "📚",
    summary: "Артикли el/la/un/una и согласование с существительным.",
  ...
  },
  {
    ...
    icon: "🔤",
    summary: "Мужской и женский род, единственное и множественное число.",
  ...
  },
  {
    ...
    icon: "🕐",
    summary: "Числа, дни недели, месяцы и время на часах.",
  ...
  },
  {
    ...
    icon: "🗺️",
    summary: "Предлоги места: en, a, de, entre, detrás, delante…",
  ...
  },
  {
    ...
    location: "Толедо",
    icon: "🛒",
    summary: "Глагол tener и выражения: tener hambre, frío, suerte…",
  ...
  },
  {
    ...
    icon: "🌿",
    summary: "Глагол gustar: me gusta / me gustan, тело и предпочтения.",
  ...
  },
  {
    ...
    location: "Мадрид",
    icon: "🚇",
    summary: "Por vs Para — причина, цель, маршрут и адресат.",
  ...
  },
  {
    ...
    icon: "⚖️",
    summary: "Сравнительная и превосходная степень: más… que, el más…",
  ...
  },
  {
    ...
    icon: "🔮",
    summary: "Futuro simple — планы и предсказания.",
  ...
  },
  {
    ...
    icon: "✒️",
    summary: "Perífrasis verbales — тонкие оттенки действия.",
