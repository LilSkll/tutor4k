...
export const CHAPTERS: Chapter[] = [
  {
    ...
    location: "Академия",
    icon: "🌅",
    summary: "Первые шаги с нуля: приветствия и два «быть» — кто ты vs как ты сейчас.",
  ...
  },
  {
    ...
    location: "Лес",
    icon: "🌲",
    summary: "Настоящее: три семьи глаголов (-ar / -er / -ir); soy/estoy уже были.",
  ...
  },
  {
    ...
    icon: "📚",
    summary: "el/la/un/una: известное vs какое-то; исключение el agua (не la abuela).",
  ...
  },
  {
    ...
    icon: "🔤",
    summary: "Мужской и женский род, один или много; agua vs abuela.",
  ...
  },
  {
    ...
    icon: "📜",
    summary: "DELE: контраст прошедших времён — indefinido, imperfecto, perfecto, pluscuamperfecto.",
  ...
  },
  {
    ...
    icon: "✉️",
    summary: "DELE: формальное и неформальное письмо — обращения, просьбы, прощания.",
  ...
  },
  {
    ...
    icon: "🌉",
    summary: "DELE: коннекторы для эссе — структура текста, мнение с indicativo/subjuntivo.",
  ...
  },
  {
    ...
    icon: "🎤",
    summary: "DELE: устная часть — описание фото, гипотезы, согласие и несогласие.",
  ...
  // ----- C2 — за пределами мастерства ---------------------------------
  {
    ...
    location: "Альгамбра",
    icon: "🪞",
    summary: "Выделительные конструкции: «Fue Juan quien…», «Lo que necesito es…».",
  ...
  },
  {
    ...
    icon: "🗞️",
    summary: "Futuro de conjetura и condicional de rumor: догадки и неподтверждённые сообщения.",
  ...
  },
  {
    ...
    icon: "🖋️",
    summary: "Книжный стиль: participio absoluto, номинализация, культурные коннекторы.",
  ...
  },
  {
    ...
    icon: "🎭",
    summary: "Ирония, сарказм и смена регистра: от бара до министерства.",
