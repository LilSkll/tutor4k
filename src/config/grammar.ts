...
## Мини: местоимения me / te / le (клитики)

С **gustar** вы впервые встречаете короткие формы «кому»:

| Кому | Форма | Пример |
|---|---|---|
| мне | **me** | **Me** gusta el café |
| тебе | **te** | **Te** gusta viajar |
| ему / ей / вам (usted) | **le** | **Le** gusta el flamenco |

Это ещё не полная система OD/OI (lo veo, le doy) — она позже. Здесь запомните: **me/te/le** стоят **перед** gusta/gustan и называют «кому нравится».
