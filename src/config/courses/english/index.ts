  ...
  return {
    ...
    keywords: {
      onTopic: [
        ...
        "shakespeare", "literature", "литератур", "poetry", "поэз",
        "thanksgiving", "british", "american english",
      ],
      offTopic: [
        "испанский", "español", "spanish grammar",
        "немецкий", "deutsch", "german grammar",
        "борщ", "рецепт борща", "готовить ужин",
        "футбол счет", "политик", "выборы",
        "программирован", "javascript", "python",
        "биткоин", "bitcoin", "math homework",
      ],
