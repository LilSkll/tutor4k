...
export function expandEnglishChapterBank(
  ...
  const typeTargets = ENGLISH_C2_THICK_CHAPTERS.has(chapterSlug)
    ? { translation: ENGLISH_C2_TR_EC_TARGET, error_correction: ENGLISH_C2_TR_EC_TARGET }
    : undefined;
